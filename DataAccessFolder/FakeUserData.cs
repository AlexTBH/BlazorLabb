    ...
    public class FakeUserData : IUserDataAccess
    {
        ...
        private List<User>? GetFakeUserData()
        {
            return new List<User>
            {
                ...
                new User { Id = 2, Name = "Kalle", Email = "Kalle@hotmail.com", Address = new Address { Street = "Stockholmsvägen 2", City = "Stockholm", Zipcode = "543 21"}, Company = new Company { Name = "Kalles kaviar", CatchPhrase = "Helt okej kaviar"} },
                new User { Id = 3, Name = "Eminem", Email = "Eminem@gmail.com", Address = new Address { Street = "8 mile", City = "Detroit", Zipcode = "313 12"}, Company = new Company { Name = "Shady Records", CatchPhrase = "Moms spaghetti"} },
